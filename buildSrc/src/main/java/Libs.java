public class Libs {
    ...
    static String constraint = "androidx.constraintlayout:constraintlayout:2.1.0";
    //navigation
    ...
    //ktx
    static String lifecycleRuntimektx = "androidx.lifecycle:lifecycle-runtime-ktx:2.4.0-alpha01";
    static String lifecycleViewModelktx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.3.1";
    static String fragmentktx = "androidx.fragment:fragment-ktx:1.3.6";
    static String activityktx = "androidx.activity:activity-ktx:1.3.1";
    //test
    ...
    //splash
    static String splashScreen = "androidx.core:core-splashscreen:1.0.0-alpha01";
    //dagger
